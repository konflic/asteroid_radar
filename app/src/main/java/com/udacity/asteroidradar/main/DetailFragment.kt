...
class DetailFragment : Fragment(),
    ...
    override fun bindViewModelData(data: Asteroid) {
        data.also { asteroid ->
            ...
            binding.detailsAbsoluteMagnitude.text =
                getString(R.string.astronomical_unit_format, asteroid.absoluteMagnitude)
            binding.detailsEstimatedDiameter.text =
                getString(R.string.km_unit_format, asteroid.estimatedDiameter)
            binding.detailsRelativeVelocity.text =
                getString(R.string.km_s_unit_format, asteroid.relativeVelocity)
            binding.detailsDistanceEarth.text =
                getString(R.string.astronomical_unit_format, asteroid.distanceFromEarth)
        }
    }
